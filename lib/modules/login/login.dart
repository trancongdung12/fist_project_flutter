    ...
    return Scaffold(
      ...
      child: SingleChildScrollView(
          child: Form(
              ...
              autovalidateMode: currentState != null && !currentState.validate()
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    margin: const EdgeInsets.only(top: 50, right: 24, left: 24),
                    child: Column(
                      children: [
                        TextInput(
                            hintText: 'Email',
                            ...
                            obscureText: false,
                            validator: (value) {
                              final text = controller.loginEmailController.text;
                        ...
                        TextInput(
                            ...
                            validator: (value) {
                              ...
                              return controller.validatePassword(value, text);
                            }),
                      ],
                    ),
                  ),
                    ...
                    children: [
                      Container(
                        ...
                        decoration: const BoxDecoration(
                            image: DecorationImage(
                                image:
                                    AssetImage('assets/images/icFacebook.png'),
                                fit: BoxFit.contain)),
                      ),
                      Container(
                        constraints:
                        ...
                        decoration: const BoxDecoration(
                            image: DecorationImage(
                                image: AssetImage('assets/images/icApple.png'),
                                fit: BoxFit.contain)),
                      ),
                      Container(
                        constraints:
                        ...
                        decoration: const BoxDecoration(
                            image: DecorationImage(
                                image: AssetImage('assets/images/icGoogle.png'),
                                fit: BoxFit.contain)),
                      ),
                    ],
                  ),
